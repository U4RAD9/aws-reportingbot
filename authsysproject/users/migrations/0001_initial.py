# Generated by Django 5.1 on 2024-08-27 08:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body_part_examined', models.CharField(blank=True, max_length=100, null=True)),
                ('accession_number', models.CharField(blank=True, max_length=20, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='EcgReport',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.CharField(max_length=50)),
                ('gender', models.CharField(max_length=50)),
                ('TestDate', models.CharField(blank=True, max_length=50, null=True)),
                ('ReportDate', models.CharField(blank=True, max_length=50, null=True)),
                ('FarVisionRight', models.CharField(blank=True, default=None, max_length=50, null=True)),
                ('FarVisionLeft', models.CharField(blank=True, default=None, max_length=50, null=True)),
                ('NearVisionRight', models.CharField(blank=True, default=None, max_length=50, null=True)),
                ('NearVisionLeft', models.CharField(blank=True, default=None, max_length=50, null=True)),
                ('ColorBlindness', models.CharField(blank=True, default=None, max_length=50, null=True)),
                ('SphericalRight', models.CharField(blank=True, default=None, max_length=50, null=True)),
                ('CylindricalRight', models.CharField(blank=True, default=None, max_length=50, null=True)),
                ('AxisRight', models.CharField(blank=True, default=None, max_length=50, null=True)),
                ('AddRight', models.CharField(blank=True, default=None, max_length=50, null=True)),
                ('SphericalLeft', models.CharField(blank=True, default=None, max_length=50, null=True)),
                ('CylindricalLeft', models.CharField(blank=True, default=None, max_length=50, null=True)),
                ('AxisLeft', models.CharField(blank=True, default=None, max_length=50, null=True)),
                ('AddLeft', models.CharField(blank=True, default=None, max_length=50, null=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='ecg_graphs/')),
                ('reportimage', models.FileField(blank=True, null=True, upload_to='ecg_graphs/')),
                ('isDone', models.BooleanField(default=False)),
