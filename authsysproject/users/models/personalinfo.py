...
class PersonalInfo(models.Model):
    ...
    signature = models.FileField(upload_to='static/signatures/', storage=S3Boto3Storage(), null=True, default=None, blank=True)
    companylogo = models.FileField(upload_to='static/companylogos/', storage=S3Boto3Storage(), null=True, default=None, blank=True)
